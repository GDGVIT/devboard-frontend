                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  {githubData?.html_url && (
                    <Button
                      ...
                      className="bg-gray-800 border-gray-600 hover:bg-gray-700 text-white w-full"
                    >
              ...
              <CardContent>
                {isLoadingWidgets ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <Button onClick={() => router.push("/widget")} className="bg-blue-600 hover:bg-blue-700 text-white">
                      <Plus className="w-4 h-4 mr-2" />
                          ...
                          <CardContent className="p-4">
                            <div className="flex items-start justify-between mb-3">
                              ...
                              <Button
                                ...
                                className="text-gray-400 hover:text-red-400 p-1 h-8 w-8 ml-2"
                              >
